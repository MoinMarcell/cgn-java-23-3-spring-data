...
import de.neuefische.cgnjava233springdata.service.CharacterService;
...
public class CharacterController {
	...
	@GetMapping
	public List<Character> getAllCars() {
		return characterService.getAllCharacters();
	}

	@PostMapping
	public List<Character> addCharacters() {
		return characterService.saveCharacters(
				List.of(
